...
patch(Ax(ai), 'XData', XData, 'YData', YData, ...
    'EdgeColor', css_standard_colors('bluegrey').^4.0, ...
    'EdgeAlpha', 0.15001, ...
    'FaceColor', 'none');
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
% Set axes props
...
CMap = css_standard_colors('bluegrey');
...
disp('Saving figure...')
exportgraphics(Fig, sprintf('figures/fig_isffeatures_%s.png', type), 'Resolution', 300)
disp('Done saving')
