...
% category colors
cat_pbo         = [0, 102, 102]./255;
cat_etc         = [255, 102, 102]./255;
cat_aw          = [51 51 51]./255;
cat_cs          = [51 51 51]./255;
...
cat_orange      = [0.850, 0.375, 0.098];
cat_black       = [0, 0, 0];
cat_bluegrey    = [0.96 0.97 0.99].^10;
cat_white       = [1, 1, 1];
cat_cyan        = [0.000, 0.737, 0.831];
cat_brick       = [0.800, 0.361, 0.361];
